...
function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
      zoom: 12,
      center: {lat: 42.9672577, lng: -85.7776507},
      scrollwheel:  false,
    ...
    var barContentString = '<div id="content">'+
      '<div id="siteNotice">'+
      '</div>'+
      '<h4>The Waldron Public House</h4>'+
      '<div id="bodyContent">'+
      '<p>The reception begins promptly at 5:30 PM at The Waldron Public House (Formerly known as McFadden’s Restaurant and Saloon). Please join us for appetizers and a cash bar. Dinner will be served at 6:30pm at The Waldron Public House as well.</p>'+
      '<a target="_blank" href="https://goo.gl/maps/x8QtUcFawg82">'+
      'Directions</a> '+
      '</div>'+
      '</div>';
      ...
      var barPosition = {lat: 42.9615274, lng: -85.6699297};

      var barMarker = new google.maps.Marker({
        position: barPosition,
        map: map,
        title: 'The Waldron Public House'
      });
